...
var createAdminCmd = &cobra.Command{
	Use:   "createAdmin",
	Short: "Create Admin",
	Long:  `Admin can create clinics and employees`,
...
func init() {
	...
	// createAdminCmd.PersistentFlags().String("email", "", "Admin's email")
	createAdminCmd.Flags().StringVarP(&Email, "e", "", "", "Admin's email")
